...
loop:
	LDR R3, [R0], 4	@Load value of memory stored in R0 + postindex				0x04903004
	ADD R4, R3      @Calculating the denominator of the PD function			    0x00844003
	SUBS R1, 1		@Subtract r1							                    0x02511001
	BGT loop		@loop if R1 not 0							                0xC8000010
	MOVW R1, 10000  @store 10000 in R1
